...
'use client';
import { Boxes, ClipboardCheck, Cross, LogIn, LogOut, LogOutIcon, Menu, Package, Plus, PlusCircle, Search, SearchIcon, Settings, ShoppingCartIcon, Tag, User, X } from "lucide-react";
          ...
          <AnimatePresence>
            {open &&
              <motion.div
                ...
                className="absolute right-0 mt-3 bg-white rounded-lg shadow-xl border border-gray-200 p-2 w-48 z-99999"
              >
                {user ? (
                  <>
                    {/* User info - only when signed in */}
